 ...
 * @author bryleo
 */
public class MoviPri extends javax.swing.JInternalFrame {
        ...
        if (t.getTamaño()>0){
            for(int i=0;i<t.getTamaño();i++){
                ...
                if(cate.getContribuyente().getDNI().equals(Registro.unregistro.getUsuario().getDNI()))
                {
                    ...
                    tbResult.setValueAt(cate.getCategoria1().getRenta(), cont, 2);
                    tbResult.setValueAt(cate.getCategoria1().getImpuestoMensual(), cont, 3);
