 ...
 * @author bryleo
 */
public class MoviSeg extends javax.swing.JInternalFrame {
        ...
        if (t.getTamaño()>0){
            for(int i=0;i<t.getTamaño();i++){
                ...
                if(cate.getContribuyente().getDNI().equals(Registro.unregistro.getUsuario().getDNI()))
                {
                    ...
                    tbResult.setValueAt(cate.getCategoria2().getIngresoNeto(), cont, 2);
                    tbResult.setValueAt(cate.getCategoria2().getImpuestoAnual(), cont, 3);
