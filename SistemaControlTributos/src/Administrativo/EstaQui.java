 ...
 * @author bryleo
 */
public class EstaQui extends javax.swing.JInternalFrame {
    ...
    void Lista()
    {
        if (t.getTamaño()>0){
            ...
            JOptionPane.showMessageDialog(this,"No se han registrados pagos de impuestos de quinta categoría","MENSAJE",JOptionPane.INFORMATION_MESSAGE);
