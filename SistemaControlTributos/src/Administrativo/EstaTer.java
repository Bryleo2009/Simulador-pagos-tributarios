 ...
 * @author bryleo
 */
public class EstaTer extends javax.swing.JInternalFrame {
    ...
    void Lista()
    {
        if (t.getTamaño()>0){
            for(int i=0;i<t.getTamaño();i++){
                ...
                tbResult.setValueAt(cate.getCategoria3().getIngresosBrutos(), i, 2);
                tbResult.setValueAt(cate.getCategoria3().getImpuesto(), i, 3);
                tbResult.setValueAt(cate.getFechaEmision().getDia()+" / "+cate.getFechaEmision().getMes()+" / "+cate.getFechaEmision().getAnio(), i, 4);
            }
        } else {
            JOptionPane.showMessageDialog(this,"No se han registrados pagos de impuestos de tercera categoría","MENSAJE",JOptionPane.INFORMATION_MESSAGE);
