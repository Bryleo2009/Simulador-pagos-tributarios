 ...
 * @author bryleo
 */
public class EstaCua extends javax.swing.JInternalFrame {
    Arreglo4Tributo t=new Arreglo4Tributo();
    /**
    ...
    void Lista()
    {
        if (t.getTamaño()>0){
            for(int i=0;i<t.getTamaño();i++){
                ...
                tbResult.setValueAt(cate.getCategoria4().getMontoDeHonorarios(), i, 2);
                tbResult.setValueAt(cate.getCategoria4().getImpuesto(), i, 3);
                tbResult.setValueAt(cate.getFechaEmision().getDia()+" / "+cate.getFechaEmision().getMes()+" / "+cate.getFechaEmision().getAnio(), i, 4);
            }
        } else {
            JOptionPane.showMessageDialog(this,"No se han registrados pagos de impuestos de cuarta categoría","MENSAJE",JOptionPane.INFORMATION_MESSAGE);
